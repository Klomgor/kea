...
DROP PROCEDURE IF EXISTS sflqUpdateLease4;
DROP PROCEDURE IF EXISTS sflqDeleteLease4;
DROP PROCEDURE IF EXISTS sflqInsertLease6;
DROP PROCEDURE IF EXISTS sflqUpdateLease6;
DROP PROCEDURE IF EXISTS sflqDeleteLease6;
